import { c as createLucideIcon, o, r as reactExports, v as vt, j as jsxRuntimeExports, e as createSlot, f as cn, g as useCartContext, h as useNavigate, L as Link, a as Button } from "./index-BaHQCgOk.js";
...
function CartTableRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.tr,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-5 pl-6 pr-4 w-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: "/product/$id",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-5 pr-6 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/product/$id",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 capitalize", children: item.product.category }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/70", children: item.product.unit })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-5 pr-6 text-right text-sm text-muted-foreground whitespace-nowrap", children: [
          "$",
          item.product.price.toFixed(2)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-5 pr-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QuantitySelector, { item, onUpdate, index }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-5 pr-6 text-right font-bold text-foreground text-sm whitespace-nowrap", children: [
          "$",
          lineTotal.toFixed(2)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-5 pr-6 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
function CartMobileCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      "data-ocid": `cart.item.${index}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/product/$id", params: { id: item.productId }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-18 h-18 w-[72px] h-[72px] rounded-xl overflow-hidden bg-muted border border-border flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: item.product.imageUrl,
            alt: item.product.name,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(QuantitySelector, { item, onUpdate, index }),
...
function EmptyCartState() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-28 h-28 rounded-full bg-primary/10 flex items-center justify-center mb-6 shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "h-14 w-14 text-primary" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-sm leading-relaxed mb-8", children: "You haven't added anything yet. Browse our fresh produce, dairy, bakery goods and more to fill your cart." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", "data-ocid": "cart.start_shopping_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "lg", className: "btn-primary px-10 text-base gap-2", children: "Start Shopping" }) })
      ]
    }
  );
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
            ...
            deliveryFee === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary", children: "Free 🎉" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
              "$",
              deliveryFee.toFixed(2)
            ] })
          ] }),
          subtotal > 0 && savingsToFreeDelivery > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.p,
            {
...
function CartPage() {
  const { items, addItem, removeItem, updateQuantity, itemCount, totalPrice } = useCartContext();
  const navigate = useNavigate();
  function handleRemove(productId, snapshot) {
    removeItem(productId);
    ue("Item removed from cart", {
  ...
  function handleCheckout() {
    ue.success("Order placed successfully! 🎉", {
      description: "Thank you for shopping at FreshMart. We'll be in touch shortly.",
      duration: 6e3
    });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Breadcrumb, { items: [{ label: "Shopping Cart" }] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-2xl sm:text-3xl font-bold text-foreground", children: [
          "Your Shopping Cart",
          itemCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-3 text-base sm:text-lg font-normal text-muted-foreground", children: [
            "(",
            itemCount,
            " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyCartState, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/30", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-4 pr-6 text-right text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Unit Price" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-4 pr-6 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Qty" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-4 pr-6 text-right text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Total" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-4 pr-6" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "popLayout", children: items.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                CartTableRow,
                {
                  item,
                  index: idx + 1,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "data-ocid": "cart.list",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "popLayout", children: items.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              CartMobileCard,
              {
                item,
                index: idx + 1,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OrderSummary, { subtotal: totalPrice, onCheckout: handleCheckout }) })
    ] }) })
  ] });
}
export {
